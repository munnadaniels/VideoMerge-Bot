...
async def start_handler(bot: Client, m: Message):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Developer - Vanajakshi", url="http://t.me/misswandabot")],
                [InlineKeyboardButton("Support Group", url="https://t.me/trooporiginals"),
                 InlineKeyboardButton("Bots Channel", url="https://t.me/trooporiginals")],
